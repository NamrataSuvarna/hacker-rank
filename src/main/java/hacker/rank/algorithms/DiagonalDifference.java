...
class DiagonalDifferenceResult {
    ...
    // Write your code here
        int diagonal1 = IntStream.range(0, arr.size()).boxed().mapToInt(i -> arr.get(i).get(i)).sum();
        int diagonal2 = IntStream.range(0, arr.size()).boxed().mapToInt(i -> arr.get(i).get(arr.size() - 1 - i)).sum();
